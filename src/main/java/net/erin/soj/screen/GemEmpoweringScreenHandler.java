...
import net.erin.soj.block.entity.GemEmpoweringStationBlockEntity;
...
//    final Slot outputSlot;
    ...
    public final Inventory input = new SimpleInventory(1){
        ...
        public void markDirty() {
            super.markDirty();
            GemEmpoweringScreenHandler.this.onContentChanged(this);
            GemEmpoweringScreenHandler.this.contentsChangedListener.run();
        }
    };
